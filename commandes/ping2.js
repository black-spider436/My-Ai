...
bravin({
  ...
  try {
    ...
    if (_0x5dcfe8 && _0x5dcfe8.length > 0) {
      ...
      const _0xc5da0f = await fetch("https://api.ibrahimadams.us.kg/api/download/ytmp4?url=" + encodeURIComponent(_0x36dbfc) + "&apikey=" + "my-vriend");
...
bravin({
  ...
  try {
    ...
    if (_0x210c78 && _0x210c78.length > 0) {
      ...
      const _0xb9018a = await fetch("https://api.ibrahimadams.us.kg/api/download/ytmp3?url=" + encodeURIComponent(_0x3c94ab) + "&apikey=" + "my-vriend");
...
bravin({
  ...
  try {
    ...
    if (_0xc59045 && _0xc59045.length > 0) {
      ...
      const _0x31e693 = await fetch("https://api.ibrahimadams.us.kg/api/download/ytmp3?url=" + encodeURIComponent(_0x25de29) + "&apikey=" + "my-vriend");
