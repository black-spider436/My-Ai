...
const { delay, loading, react } = require("../sir/bravin");
...
// bug database
const { bugtext1 } = require("../bravin/bug/bugtext1");
const { bugtext2 } = require("../bravin/bug/bugtext2");
const { bugtext3 } = require("../bravin/bug/bugtext3");
const { bugtext4 } = require("../bravin/bug/bugtext4");
const { bugtext5 } = require("../bravin/bug/bugtext5");
const { bugtext6 } = require("../bravin/bug/bugtext6");
const { bugpdf } = require("../bravin/bug/bugpdf.js");
