...
bravin({ nomCom: "deploy", categorie: "General" }, async (dest, zk, commandeOptions) => {
...
✔First type the sc ,repo or script command and you will get My Ai repository 
✔From there you are required to get your *Session id* but how,??..
         *ʜᴏᴡ ᴛᴏ ɢᴇᴛ sᴇssɪᴏɴ ɪᴅ*
✞ Open this link 👉 https://aloneteach.onrender.com/ then tap on pair code.
✞ Enter your whatsapp number with the country code e.g;  25477777777 then tap submit 
...
✞ After a successful login Leonard Md owner 😂 MY AI will send you a *session id* .some will wonder where the hell is that session ,,,...It is just right at your inbox /dm {your own number for whatsappp} 😂
...
✔ Now check on MY AI repository in github fork and give a star to this repository before doing anything 🌟or else Leonard Md owner won't allow you to deploy his bot💀.
...
let menuMsg = `
   ...
   if (lien.match(/\.(mp4|gif)$/i)) {
    try {
        zk.sendMessage(dest, { video: { url: lien }, caption:infoMsg + menuMsg, footer: "Je suis *MY tech*, déveloper MY AI Tech" , gifPlayback : true }, { quoted: ms });
    }
    catch (e) {
...
// Vérification pour .jpeg ou .png
    ...
    try {
        zk.sendMessage(dest, { image: { url: lien }, caption:infoMsg + menuMsg, footer: "Je suis *Leonard*, déveloper my Tech" }, { quoted: ms });
    }
    catch (e) {
        console.log("🥵🥵 Menu erreur " + e);
        repondre("🥵🥵 Menu erreur " + e);
